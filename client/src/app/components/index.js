...
import {addNewPost, fetchPosts, fetchPostsBy, setFilterAction} from "../lib/state/actions";
            ...
            <ul style={styles.categories}>
                {categories.map(category => {
                    return <li
                        ...
                        style={styles.category}><Link className={`category ${active === category && "active"}`}
                                                      to={`/${category === "All" ? "" : category}`}>{category}</Link>
                    </li>;
                })}
            </ul>
        </div>
